...
function journalPath(directory, capabilityName, sessionID) {
 ...
 */
export function appendResidue(directory, capabilityName, sessionID, content, kind) {
 ...
 */
export function harvestJournals(directory, clear = true) {
 ...
 */
export function formatHarvestForDreamer(entries) {
    if (entries.length === 0)
        return "No dream residue found. Journals are empty.";
    const lines = [
