 ...
 * copied-from: data/board.ts @ 06a5c44-clean
 * deltas: sessions type-import re-pointed to ./types.js (sessions.ts is node-only: bun:sqlite — its TYPE faces are copied, value faces excluded).
...
import type { SessionCard, SessionMirror } from "./types.js"
