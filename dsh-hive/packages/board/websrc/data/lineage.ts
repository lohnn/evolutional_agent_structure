 ...
 * copied-from: data/lineage.ts @ 06a5c44-clean
 * deltas: type-only import re-pointed to this package store (byte-identical module).
 ...
 */
import type { Transition, WorkItem } from "../../src/lib/board-store.js"
